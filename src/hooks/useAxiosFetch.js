...
import { fitnessApi } from '../api/post';
...
const useAxiosFetch = ( ) => {
  ...
  return {notes,proteinData,carboData,fatData,fiberData,vitaminData,mineralData,bgwInitialPlan,bgwPostPlan,blwInitialPlan,blwPostPlan,igwInitialPlan,igwPostPlan,ilwInitialPlan,ilwPostPlan,agwInitialPlan,agwPostPlan,alwInitialPlan,alwPostPlan,
